...
const replica = require('pg-replica');
...
function PostgreSQL(postgresql, settings, replications = null) {
  ...
  if (replications) {
    ...
    // this.pg = replica(master, slaves);
    this.pg = ReplicasDebug(master, slaves);
  } else {
...
const ReplicasDebug = function (writer, readers) {
